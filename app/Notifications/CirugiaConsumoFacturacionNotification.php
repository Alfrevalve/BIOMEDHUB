...
class CirugiaConsumoFacturacionNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    {
        $url = route('filament.admin.resources.cirugia-reportes.index');
    ...
    {
        return [
            'type' => 'cirugia_consumo_facturacion',
            ...
            'url' => route('filament.admin.resources.cirugia-reportes.index'),
            'message' => 'Consumo listo para facturar: ' . ($this->cirugia->nombre ?? ''),
        ];
    }
}
